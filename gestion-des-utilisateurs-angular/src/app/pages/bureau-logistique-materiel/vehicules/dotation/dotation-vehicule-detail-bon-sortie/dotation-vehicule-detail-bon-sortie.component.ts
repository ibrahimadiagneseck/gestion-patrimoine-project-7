...
import { BonDeSortie } from 'src/app/model/bon-de-sortie.model';
...
export class DotationVehiculeDetailBonSortieComponent implements OnInit, OnDestroy {
  ...
  public ajouterBonDeSortie(bonDeSortieForm: NgForm): void {
    ...
    const formattedDate = this.bonDeSortieService.formatterMyDate(dateBS);
    ...
    this.subscriptions.push(this.bonDeSortieService.ajouterBonDeSortie(bonDeSortieForm.value).subscribe({
        next: (response: BonDeSortie) => {
