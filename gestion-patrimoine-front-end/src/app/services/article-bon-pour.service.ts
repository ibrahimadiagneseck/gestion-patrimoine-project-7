...
export class ArticleBonPourService {
  ...
  public supprimerArticleBonPourById(numeroBonPour: string): Observable<CustomHttpRespone> {
    return this.httpClient.delete<CustomHttpRespone>(`${this.urlServeur}/SupprimerArticleBonPourById/${numeroBonPour}`, { withCredentials: true });
  }

  public recupererArticleBonPourById(identifiantBP: string, codeArticleBonPour: string): Observable<ArticleBonPour> {
    return this.httpClient.get<ArticleBonPour>(`${this.urlServeur}/RecupererArticleBonPourById/${identifiantBP}/${codeArticleBonPour}`, { withCredentials: true });
  }
