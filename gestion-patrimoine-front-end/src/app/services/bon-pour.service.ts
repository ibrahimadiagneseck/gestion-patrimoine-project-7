...
export class BonPourService {
  ...
  public supprimerBonPourById(identifiantBP: string): Observable<CustomHttpRespone> {
    return this.httpClient.delete<CustomHttpRespone>(`${this.urlServeur}/SupprimerBonPourById/${identifiantBP}`, { withCredentials: true });
  }

  public recupererBonPourById(identifiantBP: string): Observable<BonPour> {
    return this.httpClient.get<BonPour>(`${this.urlServeur}/RecupererBonPourById/${identifiantBP}`, { withCredentials: true });
  }
