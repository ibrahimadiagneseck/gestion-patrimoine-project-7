...
export class BonEntreeService {
  ...
  public supprimerBonEntreeById(identifiantBE: string): Observable<CustomHttpRespone> {
    return this.httpClient.delete<CustomHttpRespone>(`${this.urlServeur}/SupprimerBonEntreeById/${identifiantBE}`, { withCredentials: true });
  }

  public recupererBonEntreeById(idIdentifiantBE: string): Observable<BonEntree> {
    return this.httpClient.get<BonEntree>(`${this.urlServeur}/RecupererBonEntreeById/${idIdentifiantBE}`, { withCredentials: true });
  }
